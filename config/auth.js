...
module.exports = {
  ...
  'facebookAuth': {
    ...
    'callbackURL': 'https://retrochic.herokuapp.com/auth/facebook/callback',
  ...
  'twitterAuth': {
    ...
    'callbackURL': 'https://retrochic.herokuapp.com/auth/twitter/callback'
  },

  'googleAuth': {
    'clientID': '962976135636-48ncs7038lfi0mh0l1i5t852v098cdh2.apps.googleusercontent.com',
    'clientSecret': 'KVN6t5KLiIM-LRhNIiraFSzd',
    'callbackURL': 'https://retrochic.herokuapp.com/auth/google/callback'
  }
